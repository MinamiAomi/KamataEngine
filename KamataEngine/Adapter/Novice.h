...
class Novice {
  ...
  public:
	...
	/// <param name="fillMode">塗りつぶしモード</param>
	static void
	  DrawBox(int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4, unsigned int color, FillMode fillMode);
	/// <summary>
	/// 三角形を描画する
	/// </summary>
	...
	/// スプライトの指定矩形部分のみを描画を描画する
	/// </summary>
	/// <param name="left">描画するスプライトの左上座標 X</param>
	/// <param name="top">描画するスプライトの左上座標 X</param>
	/// <param name="width">描画するスプライトの横幅</param>
	/// <param name="height">描画するスプライトの縦幅</param>
	/// <param name="srcX">画像上の描画したい範囲左上座標 X</param>
	/// <param name="srcY">画像上の描画したい範囲左上座標 Y</param>
	/// <param name="srcW">画像上の描画したい範囲横幅</param>
	/// <param name="srcH">画像上の描画したい範囲縦幅</param>
	...
	static void ScreenPrintf(int x, int y, const char* format, va_list& args);
	/// <summary>
	...
	static void DrawTraiangl3D(const class Vector3& v1, const class Vector3& v2, const class Vector3& v3, unsigned int color1 = 0xFFFFFFFF, unsigned int color2 = 0xFFFFFFFF, unsigned int color3 = 0xFFFFFFFF);
};
